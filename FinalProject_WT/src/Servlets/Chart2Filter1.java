 ...
 */
@WebServlet(name = "Chart2Filter1",urlPatterns = "/date2")
public class Chart2Filter1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(!request.getParameter("selected_month").equals("")){


                selectedMonth = request.getParameter("selected_month");
        ...
        String query = "SELECT * FROM Monthly_Revenue WHERE month = '"+selectedMonth+ "'";
