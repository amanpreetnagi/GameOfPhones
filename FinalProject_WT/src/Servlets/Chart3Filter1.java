 ...
 */
@WebServlet(name = "Chart3Filter1", urlPatterns = "/c3f1")
public class Chart3Filter1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String query = "SELECT * FROM os_users where androidUsers > '" + hours + "'OR iosUsers > '" + hours + "' OR otherUsers > '" + hours + "'";
